...
function wpiss_init() {
	...
	wp_localize_script('iss','iss_options', array(
		'iss_suggest_url' => add_query_arg(array('action' => 'iss_suggest','_wpnonce' => wp_create_nonce( 'iss_suggest' )), trailingslashit(untrailingslashit(home_url()))),
		'iss_instant_url' => add_query_arg(array('action' => 'iss_instant','_wpnonce' => wp_create_nonce( 'iss_instant' )), trailingslashit(untrailingslashit(home_url()))),  
