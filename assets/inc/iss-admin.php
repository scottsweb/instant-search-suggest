...
/***************************************************************
* Functions wpiss_plugin_row_meta
* Add some handy shortcuts to the plugin admin screen
***************************************************************/

add_filter('plugin_row_meta', 'wpiss_plugin_row_meta', 10, 2);

function wpiss_plugin_row_meta($links, $file) {
	
	if ($file == WPISS_BASE) {

		$links[] = '<a href="'.get_admin_url().'options-general.php?page=iss-settings">' . __('Settings', 'wpiss') . '</a>';
		$links[] = '<a href="http://scott.ee/">' . __('Support', 'wpiss') . '</a>';
		$links[] = '<a href="http://twitter.com/scottsweb">' . __('Twitter','wpiss') . '</a>';
...
<div class="wrap">
	...
	<div class="scottsweb-credit">
		<a href="http://scott.ee" title="Scott Evans - Web Designer &amp; WordPress developer"><img src="<?php echo WPISS_IMAGES_URL; ?>/scott.ee.png" alt="scott logo"/></a>
		<p>Developed by <a href="http://scott.ee" title="Scott Evans - Web Designer and WordPress developer">Scott Evans</a>. If you find this plugin useful I'd be flattered to be Flattr'd:<br/><a class="FlattrButton" style="display:none; " rev="flattr;button:compact;" href="http://codecanyon.net/item/wordpress-instant-search-and-suggest/308665?ref=scottsweb"></a></p>
	</div>
